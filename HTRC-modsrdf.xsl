...
June 7, 2013: When links are supplied in the mods xml record, either via XLink or authorityURI,  these should be included in the resultant RDF.  The stylesheet now supports this for names, when  XLink is supplied.  (Will continue to enhance this for remaining cases.)
October 16, 2014  When a marccountry code is supplied in the mods xml record, use a uri rather than plain text code. CF
							...
							<xsl:element name="Geographic" namespace="http://www.loc.gov/mads/rdf/v1#">
								...
								<xsl:element name="elementList" namespace="http://www.loc.gov/mads/rdf/v1#">
									...
									<xsl:element name="GeographicElement" namespace="http://www.loc.gov/mads/rdf/v1#">
										<xsl:element name="elementValue" namespace="http://www.loc.gov/mads/rdf/v1#">
											<xsl:if test="./attribute::authority='marccountry'">http://id.loc.gov/vocabulary/countries/</xsl:if><xsl:value-of select="."/>
										</xsl:element>
									</xsl:element>
								</xsl:element>
							</xsl:element>
